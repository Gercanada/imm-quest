        ...
        <div class="row card-body">
                            ...
                            <div class="message-center chat-scroll chat-users">
                                @foreach ($groupArr2 as $key => $comm)
                                    <a href="javascript:void(0)"
                                        ...
                                        id="thread{{ $comm->cf_2218 }}" data-user-id='thread{{ $comm->cf_2218 }}'>
                                        ...
                                        <div class="mail-contnet w-75 d-inline-block v-middle pl-2">
                                            ...
                                            <span
                                                class="font-12 text-nowrap d-block text-muted text-truncate">{{ $comm->cf_2226 }}</span>
                                            <span
                                                class="font-12 text-nowrap d-block text-muted">{{ $comm->cf_2218 }}</span>
                                        </div>
                                    </a>
                                @endforeach
                            </div>
            ...
            <div class="tab-content  col-sm-9" id="v-pills-tabContent">
                <div class="p-20 chat-box-inner-part">
                    ...
                    <div class="tab-pane fade active show chatting-box mb-0" id="v-pills-home" role="tabpanel"
                                    ...
                                    @if ($comm && $comm->modifiedby === $contact->modifiedby)
                                        ...
                                        <li class="mt-4">
                                            ...
                                            <div class="chat-content pl-3 d-inline-block">
                                                ...
                                                <div
                                                    class="pr-7 box mb-2 d-inline-block text-dark rounded p-2 bg-light-info">
                                                    {{ $comm->description }}
                                                </div>
                                            </div>
                                        ...
                                        <li class="odd mt-4">
                                            <div class="chat-content pl-3 d-inline-block text-right">
                                                <div class="box mb-2 d-inline-block text-dark rounded p-2 bg-light-inverse">
                                                    {{ $comm->description }}</div>
                                                <br />
                                            </div>
                                            <div class="chat-time d-inline-block text-right text-muted">
                                                {{ $comm->cf_2226 }}|{{ $comm->cf_2228 }}</div>
                                        </li>
                                    @endif
                                @endforeach
                            </ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-10">
                                            <input type="text" name="subject" id="" placeholder="Subject"
                                                class="form-control pr-0" required data-toggle="tooltip" title="Send">
                                        </div>
                                        ...
                                        <div class="form-group col-12">
                                            <textarea placeholder="Body" class="form-control border-0" name="comment"
                                                style="margin-top: 0px; margin-bottom: 0px;" rows="2" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
