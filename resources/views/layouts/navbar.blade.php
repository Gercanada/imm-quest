    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">
            ...
            <b class="logo-icon">
                ...
                <!-- Dark Logo icon -->
                <img src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                <!-- Light Logo icon -->
            ...
            <span class="logo-text">
                ...
                <!-- Light Logo text -->
                <img src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
            </span>
        </a>
        <!-- ============================================================== -->
        <!-- End Logo -->
        ...
        <ul class="navbar-nav float-right">
                    ...
                    <ul class="list-style-none">
                        ...
                        <li>
                            <div class="message-center message-body position-relative" style="height:250px;">
                                <!-- Message -->
                                <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                    <span class="user-img position-relative d-inline-block"> <img src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/users/1.jpg" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle online"></span> </span>
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                ...
                                <!-- Message -->
                                <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                    <span class="user-img position-relative d-inline-block"> <img src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/users/2.jpg" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle busy"></span> </span>
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                ...
                                <!-- Message -->
                                <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                    <span class="user-img position-relative d-inline-block"> <img src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/users/3.jpg" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle away"></span> </span>
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                ...
                                <!-- Message -->
                                <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                    <span class="user-img position-relative d-inline-block"> <img src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/users/4.jpg" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle offline"></span> </span>
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                        <h5 class="message-title mb-0 mt-1">Pavan kumar</h5> <span class="font-12 text-nowrap d-block time text-truncate">Just see the my admin!</span> <span class="font-12 text-nowrap d-block subtext">9:02 AM</span> </div>
                                </a>
                            </div>
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <div class="container"> <img class="d-block img-fluid"
                                                    src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/big/img1.jpg" alt="First slide"></div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container"><img class="d-block img-fluid"
                                                    src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/big/img2.jpg" alt="Second slide">
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container"><img class="d-block img-fluid"
                                                    src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/big/img3.jpg" alt="Third slide"></div>
                                        </div>
                                    </div>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
                    ...
                    <img src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/users/1.jpg" alt="user" width="30" class="profile-pic rounded-circle" />
                </a>
                <div class="dropdown-menu mailbox dropdown-menu-right animated bounceInDown">
                    <ul class="dropdown-user list-style-none">
                        <li>
                            <div class="dw-user-box p-3 d-flex">
                                <div class="u-img"><img src="/templates/theme-forest-admin-pro/main/admin-pro/src/assets/images/users/1.jpg" alt="user" class="rounded" width="80"></div>
