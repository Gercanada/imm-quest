                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                        <h5 class="message-title mb-0 mt-1">Luanch Admin</h5> <span
                                            class="font-12 text-nowrap d-block time text-truncate">Just see the my new
                                            admin!</span> <span class="font-12 text-nowrap d-block subtext">9:30
                                            AM</span>
                                    </div>
                                </a>
                                <!-- Message -->
                                <a href="javascript:void(0)"
                                    ...
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                        <h5 class="message-title mb-0 mt-1">Event today</h5> <span
                                            class="font-12 text-nowrap d-block time text-truncate">Just a reminder that
                                            you have event</span> <span class="font-12 text-nowrap d-block subtext">9:10
                                            AM</span>
                                    </div>
                                </a>
                                <!-- Message -->
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                        <h5 class="message-title mb-0 mt-1">Sonu Nigam</h5> <span
                                            class="font-12 text-nowrap d-block time text-truncate">I've sung a song! See
                                            you at</span> <span class="font-12 text-nowrap d-block subtext">9:10
                                            AM</span>
                                    </div>
                                </a>
                                <!-- Message -->
                                <a href="javascript:void(0)"
                                    ...
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                        <h5 class="message-title mb-0 mt-1">Arijit Sinh</h5> <span
                                            class="font-12 text-nowrap d-block time text-truncate">I am a singer!</span>
                                        <span class="font-12 text-nowrap d-block subtext">9:08 AM</span>
                                    </div>
                                </a>
                                <!-- Message -->
                                <a href="javascript:void(0)"
