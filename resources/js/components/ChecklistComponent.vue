<template>
  <div class="card-body">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            >
              ...
              <td>
                <a :href="clitem_a.cf_1212">{{ clitem_a.cf_1212 }}</a>
              </td>
              <td>
                <a
                  :href="'/checklist/' + checklist.id + '/item/' + clitem_a.id"
                  data-toggle="tooltip"
                  title="View details"
    ...
    <div class="shadow p-1 mt-4 rounded">
      <h3 class="card-title">
        <i class="mr-1 font-18 mdi mdi-help-circle-outline"></i>Questionnaire
      </h3>
      <div class="table-responsive mt-4">
        <table class="table">
          <thead>
