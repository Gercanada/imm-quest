                ...
                <div class="row">
                  <div class="col shadow p-1 rounded pt-1">
                    <h4 class="card-title">
                      ...
                      Case
                      <b v-text="caseObj.ticket_title"></b>
                    </h4>
                  </div>
                </div>
              ...
              <div class="col py-2">
                ...
                <table class="table v-middle fs-3 mb-0 mt-4">
                  <tbody>
                    ...
                    <tr>
                      <td>Subject</td>
                      <td class="text-end font-weight-medium" v-text="clitem.name"></td>
                    </tr>
                    <tr>
                      <td>Description</td>
                      <td
                    ...
                    <tr v-if="clitem.cf_1200 === 'Questionnaire'">
                      <!-- Editables on CP -->
                      <td>Help link</td>
                      <td class="text-end font-weight-medium">
                        <a :href="clitem.cf_1212">{{ clitem.cf_1212 }}</a>
                      </td>
                    </tr>
                    <tr v-if="clitem.cf_1200 === 'Questionnaire'">
                      <td>Completed survey</td>
                      <td class="text-end font-weight-medium">
                        <p v-if="survey.length > 0 && survey.submitdate != ''">Yes</p>
                        <p v-else>No</p>
                      </td>
                    </tr>

                    <tr v-for="file in clFiles" v-if="clFiles.length > 0">
                      <td>Current file to send</td>
                      <td class="text-end font-weight-medium">
                        <div class="flex-container" v-if="appEnv === 'local'">
                          <div id="imgsrc">
                            <img
                              :src="'/storage/' + file"
                              :alt="file ? file.split('/')[9] : 'current-file'"
                            />
                          </div>
                          <label
                            for="imgsrc"
                            class="labelforimg"
                            v-text="file ? file.split('/')[9] : ''"
                          ></label>
                        </div>
                        <div v-else class="flex-container">
                          <div id="imgsrc">
                            <img
                              :src="'/storage/app/public/' + file"
                              :alt="file ? file.split('/')[9] : 'current-file'"
                            />
                          </div>
                  ...
                  >
                    ...
                    <td>
                      <button
                        ...
                        @click="exportResponse(clitem.clitemsno)"
                      >
