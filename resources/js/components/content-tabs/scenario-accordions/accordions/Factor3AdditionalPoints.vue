      ...
      <div class="row">
        ...
        <div class="col-4">
          <input
            type="text"
            disabled
            :value="maritialStatus === 'Married' ? scoreForMarried : scoreForSingle"
    ...
    >
      <div class="card-body">
        <div class="form-group">
          <div class="row">
            <div class="col-6">
              <label>Additional Points | Family Member in Canada</label>
            </div>
            <div class="col-4">
              <select
                class="form-control"
                ...
                @change="getSubFactor('Additional Points | Family Member in Canada')"
                v-model="selectedFamilyMember"
              >
                <option v-for="item in familyMembers" :value="item">
                  {{ item.Criterion }}
                </option>
              </select>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-4">
              <select
                ...
                id="select2-search-hide"
                style="width: 100%; height: 36px"
                @change="getSubFactor('Additional Points | Education')"
                v-model="selectedEducationAddPoints"
              >
                <option v-for="item in educationAdditionalPoints" :value="item">
                  {{ item.Criterion }}
                </option>
              </select>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-4">
              <select
                ...
                id="select2-search-hide"
                style="width: 100%; height: 36px"
                @change="getSubFactor('Additional Points | Job Offer')"
                v-model="selectedJobOfferAddPoints"
              >
                <option v-for="item in jobOfferAdditionalPoints" :value="item">
                  {{ item.Criterion }}
                </option>
              </select>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-4">
              <select
                ...
                id="select2-search-hide"
                style="width: 100%; height: 36px"
                @change="getSubFactor('Additional Points | PNP')"
                v-model="selectedPnp"
              >
                <option v-for="item in PNPAdditionalPoints" :value="item">
                  {{ item.Criterion }}
                </option>
              </select>
            </div>
    ...
    sumScore() {
      ...
      this.scoreForMarried =
        ...
        (this.selectedJobOfferAddPoints["Married"]
          ...
          : 0) +
        (this.selectedPnp["Married"] ? Number(this.selectedPnp["Married"]) : 0);
      ...
      this.scoreForSingle =
        ...
        (this.selectedJobOfferAddPoints["Single"]
          ...
          : 0) +
        (this.selectedPnp["Single"] ? Number(this.selectedPnp["Single"]) : 0);
    },
  },
};
</script>
