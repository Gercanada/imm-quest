...
class CriterionSeeder extends Seeder
{
    public function run()
    {
        ...
        $translated = [
            [
                "subfactor_id" => 2,
                "criterion" => "17 years of age or less",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 2,
                "criterion" => "21 to 29 years of age",
                "single" => "110",
                "married" => "100",
            ...
            [
                "subfactor_id" => 3,
                "criterion" => "Less than a secondary school credential",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 3,
                "criterion" => "Secondary School Credential",
                "single" => "30",
                "married" => "28",
            ...
            [
                "subfactor_id" => 3,
                "criterion" => "One-year post-secondary credential",
                "single" => "90",
                "married" => "84",
            ...
            [
                "subfactor_id" => 3,
                "criterion" => "Two-year post-secondary credential",
                "single" => "98",
                "married" => "91",
            ...
            [
                "subfactor_id" => 3,
                "criterion" => "Three-year or more post-secondary credential",
                "single" => "120",
                "married" => "112",
            ...
            [
                "subfactor_id" => 3,
                "criterion" => "2 or more credentials and 1 being three years or more",
                "single" => "128",
                "married" => "119",
            ...
            [
                "subfactor_id" => 4,
                "criterion" => "Reading | CLB 3 | CELPIP level 3 or less | IELTS 3 or less",
                "single" => "0",
                "married" => "0",
                "criterio" => "Reading | CLB 3 | CELPIP Nivel 3 o menos | IELTS Nivel 3 o menos",
                "id" => 30
            ],
            [
                "subfactor_id" => 4,
                "criterion" => "Reading | CLB 4 | CELPIP level 4 | IELTS 3.5",
                "single" => "6",
                "married" => "6",
            ...
            [
                "subfactor_id" => 4,
                "criterion" => "Reading | CLB 5 | CELPIP level 5 | IELTS 4",
                "single" => "6",
                "married" => "6",
            ...
            [
                "subfactor_id" => 4,
                "criterion" => "Reading | CLB 6 | CELPIP level 6 | IELTS 5.0",
                "single" => "9",
                "married" => "8",
            ...
            [
                "subfactor_id" => 4,
                "criterion" => "Reading | CLB 7 | CELPIP level 7 | IELTS 6.0 | Minimum for FSW",
                "single" => "17",
                "married" => "16",
            ...
            [
                "subfactor_id" => 4,
                "criterion" => "Reading | CLB 8 | CELPIP level 8 | IELTS 6.5",
                "single" => "23",
                "married" => "22",
            ...
            [
                "subfactor_id" => 4,
                "criterion" => "Reading | CLB 9 | CELPIP level 9 | IELTS 7.0 or 7.5",
                "single" => "31",
                "married" => "29",
            ...
            [
                "subfactor_id" => 4,
                "criterion" => "Reading | CLB 10 | CELPIP level 10 or higher | IELTS 8 and above",
                "single" => "34",
                "married" => "32",
            ...
            [
                "subfactor_id" => 5,
                "criterion" => "Listening | CLB 3 | CELPIP level 3 or less | IELTS 4 or less",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 5,
                "criterion" => "Listening | CLB 4 | CELPIP level 4 | IELTS 4.5",
                "single" => "6",
                "married" => "6",
            ...
            [
                "subfactor_id" => 5,
                "criterion" => "Listening | CLB 5 | CELPIP level 5 | IELTS 5",
                "single" => "6",
                "married" => "6",
            ...
            [
                "subfactor_id" => 5,
                "criterion" => "Listening | CLB 6 | CELPIP level 6 | IELTS 5.5",
                "single" => "9",
                "married" => "8",
            ...
            [
                "subfactor_id" => 5,
                "criterion" => "Listening | CLB 7 | CELPIP level 7 | IELTS 6 to 7 | Minimum for FSW",
                "single" => "17",
                "married" => "16",
            ...
            [
                "subfactor_id" => 5,
                "criterion" => "Listening | CLB 8 | CELPIP level 8 | IELTS 7.5",
                "single" => "23",
                "married" => "22",
            ...
            [
                "subfactor_id" => 5,
                "criterion" => "Listening | CLB 9 | CELPIP level 9 | IELTS 8",
                "single" => "31",
                "married" => "29",
            ...
            [
                "subfactor_id" => 5,
                "criterion" => "Listening |CLB 10 | CELPIP level 10 or higher | IELTS 8.5 and above",
                "single" => "34",
                "married" => "32",
            ...
            [
                "subfactor_id" => 6,
                "criterion" => "Writing | CLB 3 | CELPIP level 3 or less | IELTS 3.5 or less",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 6,
                "criterion" => "Writing | CLB 4 | CELPIP level 4 | IELTS 4 or 4.5",
                "single" => "6",
                "married" => "6",
            ...
            [
                "subfactor_id" => 6,
                "criterion" => "Writing | CLB 5 | CELPIP level 5 | IELTS 5",
                "single" => "6",
                "married" => "6",
            ...
            [
                "subfactor_id" => 6,
                "criterion" => "Writing | CLB 6 | CELPIP level 6 | IELTS 5.5",
                "single" => "9",
                "married" => "8",
            ...
            [
                "subfactor_id" => 6,
                "criterion" => "Writing | CLB 7 | CELPIP level 7 | IELTS 6.0 | Minimum for FSW",
                "single" => "17",
                "married" => "16",
            ...
            [
                "subfactor_id" => 6,
                "criterion" => "Writing | CLB 8 | CELPIP level 8 | IELTS 6.5",
                "single" => "23",
                "married" => "22",
            ...
            [
                "subfactor_id" => 6,
                "criterion" => "Writing | CLB 9 | CELPIP level 9 | IELTS 7.0 ",
                "single" => "31",
                "married" => "29",
            ...
            [
                "subfactor_id" => 6,
                "criterion" => "Writing | CLB 10 | CELPIP level 10 or higher | IELTS 7.5 and above",
                "single" => "34",
                "married" => "32",
            ...
            [
                "subfactor_id" => 7,
                "criterion" => "Speaking | CLB 3 | CELPIP level 3 or less | IELTS 3.5 or less",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 7,
                "criterion" => "Speaking | CLB 4 | CELPIP level 4 | IELTS 4 or 4.5",
                "single" => "6",
                "married" => "6",
            ...
            [
                "subfactor_id" => 7,
                "criterion" => "Speaking | CLB 5 | CELPIP level 5 | IELTS 5",
                "single" => "6",
                "married" => "6",
            ...
            [
                "subfactor_id" => 7,
                "criterion" => "Speaking | CLB 6 | CELPIP level 6 | IELTS 5.5",
                "single" => "9",
                "married" => "8",
            ...
            [
                "subfactor_id" => 7,
                "criterion" => "Speaking | CLB 7 | CELPIP level 7 | IELTS 6.0 | Minimumfor FSW",
                "single" => "17",
                "married" => "16",
            ...
            [
                "subfactor_id" => 7,
                "criterion" => "Speaking | CLB 8 | CELPIP level 8 | IELTS 6.5",
                "single" => "23",
                "married" => "22",
            ...
            [
                "subfactor_id" => 7,
                "criterion" => "Speaking | CLB 9 | CELPIP level 9 | IELTS 7.0 ",
                "single" => "31",
                "married" => "29",
            ...
            [
                "subfactor_id" => 7,
                "criterion" => "Speaking | CLB 10 | CELPIP level 10 or higher | IELTS 7.5 and above",
                "single" => "34",
                "married" => "32",
            ...
            [
                "subfactor_id" => 8,
                "criterion" => "CLB level 7 or 9",
                "single" => "3",
                "married" => "3",
                "criterio" => "CLB Nivel 7 o 9",
                "id" => 64
            ],
            [
                "subfactor_id" => 8,
                "criterion" => "CLB level 9 or higher;",
                "single" => "6",
                "married" => "6",
            ...
            [
                "subfactor_id" => 9,
                "criterion" => "No work experience or less than one year ",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 9,
                "criterion" => "1 year of Canadian work experience",
                "single" => "40",
                "married" => "35",
            ...
            [
                "subfactor_id" => 9,
                "criterion" => "2 years of Canadian work experience",
                "single" => "53",
                "married" => "46",
            ...
            [
                "subfactor_id" => 9,
                "criterion" => "3 years of Canadian work experience",
                "single" => "64",
                "married" => "56",
            ...
            [
                "subfactor_id" => 9,
                "criterion" => "4 years of Canadian work experience",
                "single" => "72",
                "married" => "63",
            ...
            [
                "subfactor_id" => 9,
                "criterion" => "5 or more years of Canadian work experience",
                "single" => "80",
                "married" => "70",
            ...
            [
                "subfactor_id" => 16,
                "criterion" => "Secondary school credential, regardless of their proficiency in their first official language",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 16,
                "criterion" => "1 or more years and CLB level 7 on all language skill areas, with one or more areas assessed at level 9",
                "single" => "13",
                "married" => "13",
            ...
            [
                "subfactor_id" => 16,
                "criterion" => "1 or more years and CLB level 9 or higher on all language skill areas",
                "single" => "25",
                "married" => "25",
            ...
            [
                "subfactor_id" => 16,
                "criterion" => "2 or more credentials, (one is 3 years or more), and CLB level 7 on all areas with 1 or more areas assessed at level 9",
                "single" => "25",
                "married" => "25",
            ...
            [
                "subfactor_id" => 16,
                "criterion" => "2 or more credentials, (one is 3 years or more), and CLB level 9 or higher on all language skill areas",
                "single" => "50",
                "married" => "50",
            ...
            [
                "subfactor_id" => 17,
                "criterion" => "Secondary school credential, regardless of their Canadian work experience",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 17,
                "criterion" => "Credential of 1 or more years or more and 1 year of Canadian work experience",
                "single" => "13",
                "married" => "13",
            ...
            [
                "subfactor_id" => 17,
                "criterion" => "Credential of 1 or more years and 2 or more years of Canadian work experience",
                "single" => "25",
                "married" => "25",
            ...
            [
                "subfactor_id" => 17,
                "criterion" => "2 or more credentials (1 must be 3+ years) and 1 year of Canadian work experience",
                "single" => "25",
                "married" => "25",
            ...
            [
                "subfactor_id" => 17,
                "criterion" => "2 or more credentials (1 must be 3+ years) and 2+ years of Canadian work experience",
                "single" => "50",
                "married" => "50",
            ...
            [
                "subfactor_id" => 18,
                "criterion" => "No foreign work experience , regardless of their proficiency",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 18,
                "criterion" => "one or two years of foreign experience and language at level 7 on all language skill areas, (1 @  level 9)",
                "single" => "13",
                "married" => "13",
            ...
            [
                "subfactor_id" => 18,
                "criterion" => "one or two years of foreign experience and language at level 9 on all language skill areas",
                "single" => "25",
                "married" => "25",
            ...
            [
                "subfactor_id" => 18,
                "criterion" => "3+ years of foreign experience and language at level 7 on all language skill areas, (1 @ level 9)",
                "single" => "25",
                "married" => "25",
            ...
            [
                "subfactor_id" => 18,
                "criterion" => "3+ years of foreign experience and language at level 9 on all language skill areas",
                "single" => "50",
                "married" => "50",
            ...
            [
                "subfactor_id" => 19,
                "criterion" => "no foreign work experience, regardless of their Canadian work experience",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 19,
                "criterion" => "one or two years of foreign work experience and one year of Canadian work experience",
                "single" => "13",
                "married" => "13",
            ...
            [
                "subfactor_id" => 19,
                "criterion" => "one or two years of foreign work experience and two or more years of Canadian work experience",
                "single" => "25",
                "married" => "25",
            ...
            [
                "subfactor_id" => 19,
                "criterion" => "three or more years of foreign work experience and one year of Canadian work experience and",
                "single" => "25",
                "married" => "25",
            ...
            [
                "subfactor_id" => 19,
                "criterion" => "three or more years of foreign work experience and two or more years of Canadian work experience.",
                "single" => "50",
                "married" => "50",
            ...
            [
                "subfactor_id" => 20,
                "criterion" => "NO certificate of Qualification",
                "single" => "0",
                "married" => "0",
                "criterio" => "Sin Certificado de Calificacion/Oficio de alguna provincia (CoQ)",
                "id" => 121
            ],
            [
                "subfactor_id" => 20,
                "criterion" => "CofQ certificate and CLB level 5 or higher on all language skill areas, with one or more areas assessed under level 7",
                "single" => "25",
                "married" => "25",
                "criterio" => "Con Certificado de Calificación/Oficio de alguna provincia (CoQ) y CLB Nivel 5 o más en inglés, y una al menos en CLB Nivel 7",
                "id" => 122
            ],
            [
                "subfactor_id" => 20,
                "criterion" => "CofQ certificate and CLB level 7 or higher on all language skill areas, ",
                "single" => "50",
                "married" => "50",
                "criterio" => "Con Certificado de Calificación/Oficio de alguna provincia (CoQ) y CLB Nivel 7 o más en todas las areas de inglés.",
                "id" => 123
            ],
            [
                "subfactor_id" => 21,
                "criterion" => "No Post secondary education in Canada or less than a year",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 21,
                "criterion" => "Post-secondary education in  Canada - credential of one or two years",
                "single" => "15",
                "married" => "15",
            ...
            [
                "subfactor_id" => 21,
                "criterion" => "Post-secondary education in  Canada - credential three years or longer",
                "single" => "30",
                "married" => "30",
                "criterio" => "Estudios en Canadá de al menos 3 años",
                "id" => 126
            ],
            [
                "subfactor_id" => 22,
                "criterion" => "No Job offer",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 22,
                "criterion" => "Arranged employment - NOC 00",
                "single" => "200",
                "married" => "200",
            ...
            [
                "subfactor_id" => 22,
                "criterion" => "Arranged employment – any other NOC 0, A or B",
                "single" => "50",
                "married" => "50",
            ...
            [
                "subfactor_id" => 24,
                "criterion" => "No Family Member in Canada",
                "single" => "0",
                "married" => "0",
            ...
            [
                "subfactor_id" => 24,
                "criterion" => "Brother or sister living in Canada who is a citizen or permanent resident of Canada",
                "single" => "15",
                "married" => "15",
